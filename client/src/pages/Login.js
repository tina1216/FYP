                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label for="remember" className="font-sans text-gray-500 dark:text-gray-300">
                        Remember me
                      </label>
                    </div>
                  </div>
                  <a
                    href="/"
                    className="text-sm font-sans font-medium text-primary-600 hover:underline dark:text-primary-500"
                  >
                    Forgot password?
                  </a>
                </div>

                <Button btn={{ text: "ログイン", color: "main" }}></Button>

                {/* <p className="text-sm font-sans font-light text-gray-500 dark:text-gray-400">
                  Don’t have an account yet?{" "}
                  <a
                    href="/"
                    className="font-sans font-medium text-primary-600 hover:underline dark:text-primary-500"
                  >
                    Sign up
                  </a>
                </p> */}
